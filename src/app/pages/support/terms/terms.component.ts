...
export class TermsComponent {
  sections = [
    { title: '1. Acceptance of terms', body: 'By creating an account or using Invitely, you agree to these Terms of Use. If you do not agree, please do not use the service.' },
    { title: '2. Permitted use', body: 'Invitely is for legitimate event planning and invitation management. You may not use Invitely for illegal activities, to harass others, to distribute spam, or to create fraudulent invitations.' },
    ...
    { title: '5. Payments', body: 'Payments processed through Invitely (asoebi, gift support, vendor subscriptions) are handled by Paystack and subject to Paystack\'s terms. Invitely charges a platform fee of 1.5% + ₦100 per transaction.' },
    { title: '6. Content', body: 'You retain ownership of content you upload (photos, videos, event details). By uploading, you grant Invitely a license to display this content as part of the service. You may not upload content that infringes copyright or is illegal.' },
    { title: '7. Termination', body: 'Invitely reserves the right to suspend or terminate accounts that violate these terms. You may delete your account at any time. Termination does not automatically refund any payments made.' },
    { title: '8. Contact', body: 'Questions about these terms can be directed to legal@invitely.app.' },
  ];
}